...
DISPLAYSURF = pygame.display.set_mode((510, 600))
...
class Player(pygame.sprite.Sprite):
    ...
    def move(self):
        pressed_keys = pygame.key.get_pressed() # updated up-down moves
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        DISPLAYSURF.fill(WHITE)
        DISPLAYSURF.blit(game_over, (75, 250))
        scores = font_small.render(f'Your score is: {COIN_SCORE}', True, BLACK)
        DISPLAYSURF.blit(scores, (150, 350))
